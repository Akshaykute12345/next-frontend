...
const id = ({ product, addAmount, initialInput }) => {
  const router = useRouter();

  const [room_type, setRoom_type] = useState("");

  let checkInDay = new Date(initialInput.checkIn);
  let checkOutDay = new Date(initialInput.checkOut);

  let duration = checkOutDay - checkInDay;

  duration = Math.ceil(duration / (1000 * 3600 * 24));
  console.log(duration + " days to stay===>");
  ...
  let basePrice = product.attributes.price;

  let finalPrice;

  if (room_type === "Super Deluxe Room") {
    basePrice = basePrice * 1.4;
  } else if (room_type === "King Room") {
    basePrice = basePrice * 1.6;
  }

  finalPrice = basePrice * duration * initialInput.rooms;
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mb-4">
                <span className="flex items-center">
                  ...
                  <span className="text-gray-600 ml-3">4/5 Rating</span>
                </span>
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                ...
                <div className="flex ml-6 items-center">
                  <span className="mr-3">Room_Type</span>
              ...
              <div className="flex">
                <span className="title-font font-medium text-2xl text-gray-900">
                  ₹{finalPrice ? finalPrice.toFixed(0) : 0}
                </span>
...
export async function getServerSideProps(context) {
  ...
  let a = await fetch(
    `https://vast-taiga-41388.herokuapp.com/api/hotels/${context.query.id}?populate=*`
  );
